...
Terakhir, melalui Peraturan Presiden Nomor 61 Tahun 2008, Badan Meteorologi dan Geofisika berganti nama menjadi Badan Meteorologi, Klimatologi, dan Geofisika (BMKG) dengan status tetap sebagai Lembaga Pemerintah Non Departemen.Pada tanggal 1 Oktober 2009 Undang-Undang Republik Indonesia Nomor 31 Tahun 2009 tentang Meteorologi, Klimatologi dan Geofisika disahkan oleh Presiden Republik Indonesia, Susilo Bambang Yudhoyono. (unduh Penjelasan UU RI Nomor 31 Tahun 2009)</p>
  ...
  <img class="card-img-top" src="<?= BASEURL;?>/img/peta covid.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Kabupaten Gresik merupakan Kabupaten penyumbang angka <br>
positif terbesar ke-3 di jawa timur.
Oleh sebab itu maka kita harus menjaga kelangsungan kehidupan.</p>
<a href="<?= BASEURL; ?>/about/covid"><button type="button"class="btn btn-success" class="rounded-pill">Selanjutnya</button></a>
  </div>
</div>
